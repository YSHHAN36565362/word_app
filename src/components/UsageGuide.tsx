...
const FEATURE_ITEMS: GuideItem[] = [
  ...
  },
  {
    ...
    body: (
      <>
        맞힌 단어일수록 다음 복습까지의 간격이 <b>1일 → 3일 → 7일 ...</b>로 점점
        늘어나고, 틀리면 다시 0으로 돌아갑니다(SuperMemo-2 방식에서 착안). 그 주기가 다
        된 단어는 &ldquo;복습&rdquo; 화면 위쪽에 <b>&ldquo;오늘의 복습&rdquo;</b> 카드로
        모여서, 지금 다시 봐야 할 단어만 골라 바로 연습을 시작할 수 있습니다.
      </>
    ),
  },
  {
