  ...
  },
  {
    ...
    body: (
      <>
        ...
        애플펜슬(또는 마우스)로만 그려지고 손가락 터치는 무시되어, 아이패드에서 손바닥을
        대고 써도 그려지지 않습니다. 오른쪽 아래 모서리를 끌어 크기를 바꿀 수 있고,
        <b>지우기</b>로 전체를 지울 수 있습니다. <b>닫기</b>를 눌러도 그리던 내용은
        남아있어서, memo 버튼을 다시 누르면 이어서 쓸 수 있습니다.
      </>
    ),
  },
  {
